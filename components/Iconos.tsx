...
export function IconoGitHub({ className = "size-5" }: IconoProps) {
  return (
...
export function IconoCorreo({ className = "size-5" }: IconoProps) {
  return (
...
export function IconoFlecha({ className = "size-4" }: IconoProps) {
  return (
...
export function IconoUbicacion({ className = "size-4" }: IconoProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} aria-hidden="true" className={className}>
      <path d="M12 21s7-5.6 7-11.5a7 7 0 1 0-14 0C5 15.4 12 21 12 21Z" strokeLinejoin="round" />
